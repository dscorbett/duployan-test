...
if (window.location.pathname === '/') {
    ...
    assertTransliterates('wo.w', '𛱝‌𛱛̌');
    ...
    assertTransliterates('pa~', '𛰂𛱤́');
    assertTransliterates('po~', '𛰂𛱢̗');
    assertTransliterates('pi~', '𛰂𛱤̀');
    assertTransliterates('pu~', '𛰂𛱢̖');
    ...
    assertTransliterates('ta~', '𛰃𛱤́');
    assertTransliterates('to~', '𛰃𛱢̗');
    assertTransliterates('ti~', '𛰃𛱤̀');
    assertTransliterates('tu~', '𛰃𛱢̖');
    ...
    assertTransliterates('fa~', '𛰄𛱤́');
    assertTransliterates('fo~', '𛰄𛱢̗');
    assertTransliterates('fi~', '𛰄𛱤̀');
    assertTransliterates('fu~', '𛰄𛱢̖');
    ...
    assertTransliterates('ka~', '𛰅𛱤́');
    assertTransliterates('ko~', '𛰅𛱤̗');
    assertTransliterates('ki~', '𛰅𛱤̀');
    assertTransliterates('ku~', '𛰅𛱤̖');
    ...
    assertTransliterates('la~', '𛰆𛱢́');
    assertTransliterates('lo~', '𛰆𛱢̗');
    assertTransliterates('li~', '𛰆𛱢̀');
    assertTransliterates('lu~', '𛰆𛱢̖');
    ...
    assertTransliterates('sa~', '𛰜𛱢́');
    assertTransliterates('so~', '𛰜𛱢̗');
    assertTransliterates('si~', '𛰜𛱢̀');
    assertTransliterates('su~', '𛰜𛱢̖');
    assertTransliterates('na', '𛰚𛱁');
    assertTransliterates('nai', '𛰚𛱁𛱋');
    assertTransliterates('naī', '𛰚𛱁𛱋̣');
    assertTransliterates('naī\\1', '𛰚𛱁𛱆̣');
    ...
    assertTransliterates('na~', '𛰚𛱢́');
    assertTransliterates('no~', '𛰚𛱢̗');
    assertTransliterates('ni~', '𛰚𛱢̀');
    assertTransliterates('nu~', '𛰚𛱢̖');
    ...
    assertTransliterates('ma~', '𛰙𛱢́');
    assertTransliterates('mo~', '𛰙𛱢̗');
    assertTransliterates('mi~', '𛰙𛱢̀');
    assertTransliterates('mu~', '𛰙𛱢̖');
    ...
    assertTransliterates('a~p', '𛱤́𛰂');
    assertTransliterates('a~t', '𛱢́𛰃');
    assertTransliterates('a~f', '𛱤́𛰄');
    assertTransliterates('a~k', '𛱤́𛰅');
    assertTransliterates('a~l', '𛱢́𛰆');
    assertTransliterates('a~sh', '𛱢́𛰛');
    assertTransliterates('a~s', '𛱢́𛰜');
    assertTransliterates('a~n', '𛱢́𛰚');
    assertTransliterates('a~m', '𛱢́𛰙');
    assertTransliterates('o~p', '𛱤̗𛰂');
    assertTransliterates('o~t', '𛱢̗𛰃');
    assertTransliterates('o~f', '𛱤̗𛰄');
    assertTransliterates('o~k', '𛱤̗𛰅');
    assertTransliterates('o~l', '𛱢̗𛰆');
    assertTransliterates('o~sh', '𛱢̗𛰛');
    assertTransliterates('o~s', '𛱢̗𛰜');
    assertTransliterates('o~n', '𛱢̗𛰚');
    assertTransliterates('o~m', '𛱢̗𛰙');
    assertTransliterates('i~p', '𛱤̀𛰂');
    assertTransliterates('i~t', '𛱢̀𛰃');
    assertTransliterates('i~f', '𛱤̀𛰄');
    assertTransliterates('i~k', '𛱤̀𛰅');
    assertTransliterates('i~l', '𛱢̀𛰆');
    assertTransliterates('i~sh', '𛱢̀𛰛');
    assertTransliterates('i~s', '𛱢̀𛰜');
    assertTransliterates('i~n', '𛱢̀𛰚');
    assertTransliterates('i~m', '𛱢̀𛰙');
    assertTransliterates('u~p', '𛱤̖𛰂');
    assertTransliterates('u~t', '𛱢̖𛰃');
    assertTransliterates('u~f', '𛱤̖𛰄');
    assertTransliterates('u~k', '𛱤̖𛰅');
    assertTransliterates('u~l', '𛱢̖𛰆');
    assertTransliterates('u~sh', '𛱢̖𛰛');
    assertTransliterates('u~s', '𛱢̖𛰜');
    assertTransliterates('u~n', '𛱢̖𛰚');
    assertTransliterates('u~m', '𛱢̖𛰙');

    // CVC syllables
    assertTransliterates('ta~p', '𛰃𛱤́𛰂');
    assertTransliterates('ta~t', '𛰃𛱢́𛰃');
    assertTransliterates('ta~f', '𛰃𛱤́𛰄');
    assertTransliterates('ta~k', '𛰃𛱤́𛰅');
    assertTransliterates('ta~l', '𛰃𛱢́𛰆');
    assertTransliterates('ta~sh', '𛰃𛱢́𛰛');
    assertTransliterates('ta~s', '𛰃𛱢́𛰜');
    assertTransliterates('ta~n', '𛰃𛱢́𛰚');
    assertTransliterates('ta~m', '𛰃𛱢́𛰙');
    assertTransliterates('to~p', '𛰃𛱢̗𛰂');
    assertTransliterates('to~t', '𛰃𛱢̗𛰃');
    assertTransliterates('to~f', '𛰃𛱢̗𛰄');
    assertTransliterates('to~k', '𛰃𛱢̗𛰅');
    assertTransliterates('to~l', '𛰃𛱢̗𛰆');
    assertTransliterates('to~sh', '𛰃𛱢̗𛰛');
    assertTransliterates('to~s', '𛰃𛱢̗𛰜');
    assertTransliterates('to~n', '𛰃𛱢̗𛰚');
    assertTransliterates('to~m', '𛰃𛱢̗𛰙');
    assertTransliterates('ti~p', '𛰃𛱤̀𛰂');
    assertTransliterates('ti~t', '𛰃𛱢̀𛰃');
    assertTransliterates('ti~f', '𛰃𛱤̀𛰄');
    assertTransliterates('ti~k', '𛰃𛱤̀𛰅');
    assertTransliterates('ti~l', '𛰃𛱢̀𛰆');
    assertTransliterates('ti~sh', '𛰃𛱢̀𛰛');
    assertTransliterates('ti~s', '𛰃𛱢̀𛰜');
    assertTransliterates('ti~n', '𛰃𛱢̀𛰚');
    assertTransliterates('ti~m', '𛰃𛱢̀𛰙');
    assertTransliterates('tu~p', '𛰃𛱢̖𛰂');
    assertTransliterates('tu~t', '𛰃𛱢̖𛰃');
    assertTransliterates('tu~f', '𛰃𛱢̖𛰄');
    assertTransliterates('tu~k', '𛰃𛱢̖𛰅');
    assertTransliterates('tu~l', '𛰃𛱢̖𛰆');
    assertTransliterates('tu~sh', '𛰃𛱢̖𛰛');
    assertTransliterates('tu~s', '𛰃𛱢̖𛰜');
    assertTransliterates('tu~n', '𛰃𛱢̖𛰚');
    assertTransliterates('tu~m', '𛰃𛱢̖𛰙');
    ...
    assertTransliterates('klaska', '𛰅𛰆𛱁𛰜‌𛰅𛱁');
    ...
    assertTransliterates('chəqw', '𛰣𛱄𛰅')
    ...
    assertTransliterates('iawa', '𛱊𛱁‌𛱜');
