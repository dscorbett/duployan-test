...
function transliterate(inputValue, autotransliterate = true, autosyllabify = true, textBefore = '') {
    ...
    return inputValue.match(RegExp((disabled ? '^[^>]+|' : '') + '<[^>]*>?|[^<]+', 'g')).map(substring => {
        ...
        substring = (substring
            ...
            .replaceAll(/[ǝә]/g, 'ə')
            .replaceAll(/u~|ə̃/g, 'ũ')
            .replaceAll(/(j\u0361|y)[uúū]/g, 'ü')
            .replaceAll(/t͡ʃ|ǰ/g, 'č')
            .replaceAll(/[\u0300-\u0302\u030C\u0313\u032C\u0361ˈˌ·ˑ]/g, '')
            .replaceAll(/[ĥիẖ]/g, 'h')
            .replaceAll(/[ʹʻʼˈˌ‘’]/g, "'")
            .replaceAll('ʷ', 'w')
            .replaceAll(/x̌|x̱/g, 'x̣')
            .replaceAll('\u0325', '\u0323')
            .replaceAll('ɂ', 'ʔ')
            ...
            .replaceAll('z', 's')
            .replaceAll('ƛ', 'tɬ')
            .replaceAll(/[àáâäåæāăǽȁɑ]/g, 'a')
            .replaceAll(/o[ou]/g, 'u')
            .replaceAll(/[èéêëēĕȅɛ]/g, 'e')
            .replaceAll(/[ìíîïĭȉ]/g, 'i')
            .replaceAll(/[òóôō]/g, 'o')
            .replaceAll(/[ùúū]/g, 'u')
        ...
        return substring.match(RegExp(`(?!\u034F)[${wordCharacter}]+|\u034F+|[^${wordCharacter}]*`, 'gu')).map(word => {
            ...
            word = (word
                ...
                .replaceAll(RegExp(`(?<!${consonant}${vowel}*)\u{1BC46}(?=\\p{M}*(P|${iVowel}${vowel}*${consonant}))`, 'gu'), '$&R')
